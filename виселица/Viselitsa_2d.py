...
def final(final): # после того, как пользователь угадал слово или проиграл
    ...
    if final == 1: # если пользователь победил
        ...
        final_text = texts(WIDTH / 2, HEIGHT * 0.3, f"Правильное слово - {secret} \n \n - {level * 233} сошиал кредитс (((", RED, bigfont)
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("Viselitsa")
    pygame.display.set_icon(pygame.image.load(resource_path(r'images/icon.ico')))
